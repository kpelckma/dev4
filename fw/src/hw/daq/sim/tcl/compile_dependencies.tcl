...
#-----------------------------------------------------------------------
quietly set fwPath "../../../.."
#quietly set root_path "${fwPath}/tools/UVVM"
...
# MSK dependencies
#quietly set module_misc_daq_src_hdl  {}
#quietly lappend module_misc_daq_src_hdl $fwPath/libraries/pkg/PKG_TYPES.vhd
source "module.tcl"
foreach item $module_misc_daq_src_tb {
  echo "eval vcom -2008 $item"
  eval vcom -2008 "$item"
}
foreach item $module_misc_daq_src_hdl {
  echo "eval vcom -2008 $item"
  eval vcom -2008 "$item"
}
