...
//--------------------------------------------------------------------------------
//Command: generate_target bd_c7d2.bd
//Design : bd_c7d2
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_c7d2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_c7d2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=38,numReposBlks=30,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "sis8300ku_bsp_system_axi_interconnect_dma_0.hwdef" *) 
module bd_c7d2
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
    ...
    aclk,
    aresetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M00_AXI, ADDR_WIDTH 64, ARUSER_WIDTH 114, AWUSER_WIDTH 114, BUSER_WIDTH 0, CLK_DOMAIN sis8300ku_bsp_system_xdma_0_0_axi_aclk, DATA_WIDTH 256, FREQ_HZ 125000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 2, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 32, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 14, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 14" *) output [63:0]M00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M01_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M01_AXI, ADDR_WIDTH 64, ARUSER_WIDTH 114, AWUSER_WIDTH 114, BUSER_WIDTH 114, CLK_DOMAIN sis8300ku_bsp_system_xdma_0_0_axi_aclk, DATA_WIDTH 256, FREQ_HZ 125000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 2, INSERT_VIP 0, MAX_BURST_LENGTH 128, NUM_READ_OUTSTANDING 32, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 14, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 14" *) output [63:0]M01_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:M01_AXI:S00_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN sis8300ku_bsp_system_xdma_0_0_axi_aclk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input aclk;
  ...
  wire [275:0]m01_nodes_M_SC_R_PAYLD;
  ...
  m00_exit_pipeline_imp_5926II m00_exit_pipeline
  ...
  m00_nodes_imp_IJOOYE m00_nodes
  ...
  m01_exit_pipeline_imp_1LMRP6 m01_exit_pipeline
  ...
  m01_nodes_imp_1Q3WRHC m01_nodes
  ...
  s00_entry_pipeline_imp_14G175L s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_10RF2W3 s00_nodes
  ...
  switchboards_imp_1UGP7JR switchboards
...
module m00_exit_pipeline_imp_5926II
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m01_exit_pipeline_imp_1LMRP6
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m01_nodes_imp_1Q3WRHC
  ...
  wire [275:0]m01_r_node_M_SC_PAYLD;
  ...
  assign M_SC_R_payld[275:0] = m01_r_node_M_SC_PAYLD;
...
module s00_entry_pipeline_imp_14G175L
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_c7d2_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_c7d2_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_c7d2_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_1UGP7JR
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
  ...
  assign S01_SC_R_1_PAYLD = S01_SC_R_payld[275:0];
