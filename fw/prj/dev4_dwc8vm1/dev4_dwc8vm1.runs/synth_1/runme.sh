...
HD_PWD='/home/kristiaanpelckmans/Downloads/dev4/fw/prj/dev4_dwc8vm1/dev4_dwc8vm1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bsp_sis8300ku_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bsp_sis8300ku_top.tcl
